...
import { useLoading } from '@/hooks/LoadingContext'; // <-- IMPORT THE HOOK
...
const DepartmentsSection = () => {
  ...
  const departments = [
    ...
    { id: 1, name: 'Computer Engineering', slug: 'computer-engineering', icon: Computer, description: 'The department is committed to contribute significantly to Information Technology and continues to grow professionally with expertise and knowledge to compete with international levels of excellence.', color: 'from-blue-500 to-blue-600', bgColor: 'bg-blue-50', iconColor: 'text-blue-600' },
    { id: 2, name: 'Civil Engineering', slug: 'civil-engineering', icon: Building, description: 'Civil Engineering is perhaps the broadest of all the Engineering fields, for it deals with large buildings, roads, bridges, canals, rail road lines, airports, water supply systems, dams, irrigation, harbours, tunnels, and other Engineered constructions.', color: 'from-gray-500 to-gray-600', bgColor: 'bg-gray-50', iconColor: 'text-gray-600' },
    { id: 3, name: 'Petrochemical Engineering', slug: 'petrochemical-engineering', icon: Settings, description: 'India with excellent refining capacity ranks sixth in the world with public/private companies like Reliance, Essar, ONGC-MRPL, HPCL, BPCL, IOC etc. Huge opportunities in oil and gas industry.', color: 'from-orange-500 to-orange-600', bgColor: 'bg-orange-50', iconColor: 'text-orange-600' },
    { id: 4, name: 'Automobile Engineering', slug: 'automobile-engineering', icon: Car, description: 'Training students with world class standards of design, automation, aesthetics and ergonomics using latest equipment like UTM, CNC Machine, and advanced software.', color: 'from-red-500 to-red-600', bgColor: 'bg-red-50', iconColor: 'text-red-600' },
    { id: 5, name: 'Chemical Engineering', slug: 'chemical-engineering', icon: Beaker, description: 'Focused on chemical processes and manufacturing with modern laboratory facilities and industry connections.', color: 'from-green-500 to-green-600', bgColor: 'bg-green-50', iconColor: 'text-green-600' },
    { id: 6, name: 'Electronics & Communication Engineering (ECE)', slug: 'ece', icon: Cpu, description: 'Electronic Engineering deals with research, design, integration and application of circuits and devices used in transmission and processing of information.', color: 'from-purple-500 to-purple-600', bgColor: 'bg-purple-50', iconColor: 'text-purple-600' },
    { id: 7, name: 'Electrical & Electronics Engineering (EEE)', slug: 'eee', icon: Zap, description: 'Electrical Engineering covering power systems, electronics, and communication technologies.', color: 'from-yellow-500 to-yellow-600', bgColor: 'bg-yellow-50', iconColor: 'text-yellow-600' },
    { id: 8, name: 'Mechanical Engineering', slug: 'mechanical-engineering', icon: Cog, description: 'Training with world class standards using latest equipment like UTM, CNC Machine, and advanced manufacturing technologies.', color: 'from-indigo-500 to-indigo-600', bgColor: 'bg-indigo-50', iconColor: 'text-indigo-600' },
    { id: 9, name: 'Diploma in Medical Laboratory Technology (DMLT)', slug: 'dmlt', icon: Heart, description: 'Medical Laboratory Technology program training candidates to handle advanced lab equipment and perform accurate medical laboratory tests with practical training.', color: 'from-pink-500 to-pink-600', bgColor: 'bg-pink-50', iconColor: 'text-pink-600', isNew: true }
  ];
            ...
            return (
              <div key={dept.id} className="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden hover:scale-105">
                ...
                <div className="relative p-8">
                  ...
                  <p className="text-gray-600 leading-relaxed mb-6 line-clamp-4">{dept.description}</p>
                  <Button 
                    className={`w-full bg-gradient-to-r ${dept.color} hover:opacity-90 text-white font-semibold group relative overflow-hidden`}
                    onClick={() => handleLearnMoreClick(dept.slug)} // <-- USE THE NEW HANDLER
                  >
